...
url = f"https://us-documentai.googleapis.com/v1beta3/projects/1056864635772/locations/us/processors/{processor_id}/dataset:importDocuments"
    ...
    "batchDocumentsImportConfigs": [
        {
            ...
            "batchInputConfig": {
                "gcsPrefix": {
                    "gcsUriPrefix": "gs://docai-training-1056864635772/AU Bank Statements/"
                }
            }
        }
    ]
